import { CreateArticleValidate } from "@/types/articleTypes";
import { z } from "zod";
...
export const validateCreateArticle = (data: CreateArticleValidate) => createArticleSchema.safeParse(data);
...
export const validateUpdateArticle = (data: any) => updateArticleSchema.safeParse(data);
export const validateImage = (data: any) => imageurls.safeParse(data);